...
const WarehouseEdit = (
    {warehouse = DummyWarehouse}:WarehouseEditProps):JSX.Element => {
                        const [wh, setWarehouse] = useState<Warehouse>(warehouse);
                        ...
                        <>
                            ...
                            <fieldset>
                                ...
                                <div>
                                    <label htmlFor='inpInternational'> Accepts international
                                    shipments?: </label>
